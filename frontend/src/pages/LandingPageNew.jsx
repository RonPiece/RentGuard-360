...
const LandingPageNew = () => {
    ...
    const handleRegister = async (e) => {
        ...
        if (check.status === 'SOCIAL_ONLY') {
            ...
            setError(isRTL ? 'האימייל הזה מחובר לחשבון חברתי. יש להתחבר דרך Google.' : 'This email is linked to a social account. Please sign in with Google.');
            setLoading(false);
            return;
        }
                    ...
                    <div className="auth-modal" onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className="auth-form">
                            ...
                            <p className="confirm-msg" style={{ textAlign: 'center' }}>
                                {isRTL
                                    ? 'האימייל הזה כבר מקושר להתחברות חברתית. כדי להמשיך, התחבר דרך Google.'
                                    : 'This email is already linked to a social login. Continue with Google.'}
                            </p>
                            <button
                                type="button"
                                className="auth-social-btn google"
